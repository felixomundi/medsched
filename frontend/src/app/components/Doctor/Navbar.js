...
function Navbar() {
  ...
  return (
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
        ...
        <li className="nav-item">
          <Link className="nav-link text-white" href="/doctor/appointments">
            Appointments
          </Link>
        </li>        
        
        <li className="nav-item">
          <Link className="nav-link text-white" href="/doctor/appointments/types">
          Appointments Types
          </Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link text-white" href="/doctor/specialties">
            My Specialties
          </Link>
        </li>  
        <li className="nav-item">
          <Link className="nav-link text-white" href="/doctor/reminders">
           Reminders
          </Link>
        </li>          
