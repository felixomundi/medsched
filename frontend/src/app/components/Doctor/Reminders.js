...
export default function RemindersComponent() {
  ...
  const [filters, setFilters] = useState({
    ...
    'Appointment.patient.name': { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.CONTAINS }] },
        ...
        <section className="reminders">      
            <div className="table-responsive">
              <DataTable
                ...
                filters={filters}
                globalFilterFields={['id', 'status', 'method', 'Appointment.appointmentDate', 'Appointment.startTime', 'Appointment.patient.name']}
                header={
              ...
              >
                ...
                <Column field="Appointment.patient.name" header="Patient" sortable filter filterField="Appointment.patient.name" filterMatchMode={FilterMatchMode.CONTAINS}></Column>
