  ...
  return (
    <div className="container py-3">     
      <Row>        
        ...
        {/* <Col md={6}>
          <Link href="/admin/medical-history/create" className='btn btn-primary'>Create Medical Record</Link>
        </Col> */}
      </Row>
          ...
          loading={loading}
           paginator rows={10}
            ...
            responsiveLayout="scroll"
              filters={filters}
              globalFilterFields={['id', 'visitDate', 'followUpDate', "medications", "symptoms",  'patient.name', "appointment.AppointmentType.name", "appointment.specialty", "doctor.name"]}
            ...
            >
               <Column field="id" filter sortable header="ID" />
                        ...
                        <Column field="patient.name" filter sortable header="Patient" />
